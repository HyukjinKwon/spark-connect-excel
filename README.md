...
- Excel **desktop** (Microsoft 365 / 2019, Windows or Mac) to run the engine. (No Excel? The standalone web demo runs the same engine in any Chromium browser.)
...
| Component | Supported |
|-----------|-----------|
| Excel (engine) | Microsoft 365 / 2019 **desktop** - Windows or Mac (Excel on the web is not supported) |
...
| Engine WebView | Chromium-based (Windows WebView2) - `COEP: credentialless` is a Chromium feature |
| Node | 20 LTS |
